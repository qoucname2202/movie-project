              ...
              <form onSubmit={handleSubmit(handleUpload)}>
                <div className="form-group row">
                  ...
                  <div className="col-md-10">
                    <input
                      type="text"
                      placeholder={t('reviews.emptyTitle')}
                      {...register('title', {
                        required: true,
                      })}
                      className="form-control"
                    />
                    {errors?.title?.type === 'required' && <p className="text-danger">{t('reviews.emptyTitle')}</p>}
                  </div>
                </div>
                <div className="form-group row">
                  ...
                  <div className="col-md-10">
                    ...
                    {errors?.thumb?.type === 'required' && <p className="text-danger">{t('reviews.emptyPoster')}</p>}
                  </div>
                </div>
                <div className="form-group row">
                  ...
                  <div className="col-md-10">
                    <textarea
                      ...
                      className="form-control"
                    />
                    {errors?.content?.type === 'required' && <p className="text-danger">{t('reviews.emptyContent')}</p>}
                  </div>
                </div>
