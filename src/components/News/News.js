      ...
      <div className="container">
        <ul className="nav nav-pills" id="pills-tab" role="tablist">
          <li className="nav-item" role="presentation">
            <a
              ...
              id="cinema-24h"
              data-toggle="tab"
              href="https://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-ainema-24h-show"
              role="tab"
          ...
          <li className="nav-item" role="presentation">
            <a
              ...
              id="revies-tab"
              data-toggle="tab"
              href="https://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-aevies-tab-show"
              role="tab"
          ...
          <li className="nav-item" role="presentation">
            <a
              ...
              id="sales-tab"
              data-toggle="tab"
              href="https://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-aales-tab-show"
              role="tab"
        ...
        <div className="tab-content" id="pills-tabContent">
          ...
          >
            <div className="row">
              <div className="col-md-6 block-news-img">
                ...
                <a
                  href="https://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-atps://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-a"
                  className="ttl"
                >
            ...
            <div className="row">
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Làng phim đương đại những năm qua chứng kiến sự lên ngôi của
                  cái tên Christopher Nolan, được biết tới như một trong những
                  đạo diễn thiên tài với khả...{" "}
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
                  <img src="./images/iconComment.png" alt="" />1
              ...
              <div className="col-md-4 block-new-col">
                <a
                  href="https://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-atps://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-a"
                  className="col-news row"
                >
                  <img src="./images/new5.png" alt="" className="img-fluid" />
                  <p className="ttl">
                    6 đạo diễn tỉ đô làm nên thành công của những bom tấn đình
                    đám
                  </p>
                </a>
                <a
                  href="https://www.galaxycine.vn/binh-luan-phim/review-turning-red-mat-trai-cua-nhung-gia-dinh-chau-a"
                  className="col-news row"
                >
          ...
          <div
            ...
            id="revies-tab-show"
            role="tabpanel"
            aria-labelledby="revies-tab-show"
          >
            <div className="row">
              <div className="col-md-6 block-news-img">
          ...
          <div
            ...
            id="sales-tab-show"
            role="tabpanel"
            aria-labelledby="sales-tab-show"
          >
            <div className="row">
              <div className="col-md-6 block-news-img">
            ...
            <div className="row">
              ...
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Từ giờ đến 05.12.2019, chỉ cần lần đầu mua vé trên 123Phim,
                  chọn thanh toán bằng ZaloPay hoặc mục Vé Phim trên ZaloPay,
                  bạn có thể đặt ngay vé phim Anh Trai Yêu Quái với giá chỉ
                  11k/vé.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 1
