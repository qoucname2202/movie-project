          ...
          >
            <div className="row">
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Không đi theo lối mòn máu me, hù dọa mà đầu tư khai thác những mảng tối của xã hội trên nền một câu
            ...
            <div className="row">
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Làng phim đương đại những năm qua chứng kiến sự lên ngôi của cái tên Christopher Nolan, được biết tới
                  như một trong những đạo diễn thiên tài với khả...{' '}
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
                  <img src="./images/iconComment.png" alt="" />1
              ...
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Sau 7 năm kể từ New World – bộ phim đạt thành tích hơn 4.68 triệu vé, hai tên tuổi lão làng trong làng
                  điện ảnh Hàn Quốc mới tiếp tục tái hợp trong Truy Cùng Giết Tận – một bộ phim hành động siêu “nặng
                  đô”...
                </p>
                <p className="icon-comment">
            ...
            <div className="row">
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Đêm qua theo giờ Việt Nam, hãng phim Warner Bros. đưa ra thông báo chính thức về ngày khởi chiếu cho
                  bom tấn TENET tại các thị trường bên ngoài Bắc Mỹ, trong đó có Việt Nam.{' '}
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 2
                  <img src="./images/iconComment.png" alt="" />1
              ...
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Là bộ phim tâm lý li kỳ với chủ đề tội phạm, Bằng Chứng Vô Hình mang đến một góc nhìn mới về hình ảnh
          ...
          <div className="tab-pane fade" id="revies-tab-show" role="tabpanel" aria-labelledby="revies-tab-show">
            <div className="row">
              ...
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Tuy là một bộ phim có chất lượng tốt, nhưng có vẻ Dinh Thự Oan Khuất vẫn chưa đủ để đem khán giả trở
                  lại phòng vé!
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
            ...
            <div className="row">
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Tác phẩm nhận đề cử Phim truyện xuất sắc tại Oscar 2019 của đạo diễn Spike Lee là một lát cắt nữa về
                  nạn phân biệt chủng tộc - nỗi đau gây nhức nhối nước Mỹ cho tới tận hôm nay.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
                  <img src="./images/iconComment.png" alt="" />1
              ...
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  American Sniper khắc họa một tay súng bắn tỉa “huyền thoại” của Hải quân Mỹ với 4 lần tham chiến ở
                  Trung Đông. Câu chuyện phim chậm rãi đưa người xem qua từng thời khắc khác nhau của Kyle, từ thửa nhỏ,
                  thiếu niên, rồi gia nhập quân đội, rồi tham chiến. Từng khoảnh khắc bắt đầu nhẹ nhàng...
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 1
                  <img src="./images/iconComment.png" alt="" />0
            ...
            <div className="row">
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Như hai phần phim trước, Nắng 3 tiếp tục mang đến câu chuyện tình cha, mẹ - con đầy nước mắt của bộ ba
                  nhân vật chính.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 2
          ...
          <div className="tab-pane fade" id="sales-tab-show" role="tabpanel" aria-labelledby="sales-tab-show">
            <div className="row">
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  ĐỒNG GIÁ 1K/VÉ KHI MUA VÉ QUA TIX Hành trình tìm Ròm và Phúc chỉ với 1k cả tuần + nhận thêm 02 voucher
                  khi đặt vé qua TIX.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 2
              ...
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Tận hưởng Ưu Đãi lên đến 3 VÉ BHD Star mỗi tuần chỉ với giá 59k/vé khi mua vé trên TIX và thanh toán
                  bằng ZaloPay hoặc Mục Vé Phim trên ZaloPay.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
                  <img src="./images/iconComment.png" alt="" />1
            ...
            <div className="row">
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Từ thứ 7 tuần này (9/5), toàn bộ các rạp Beta Cinemas trên toàn quốc sẽ mở cửa trở lại. Mừng ngày trở
                  lại, hàng loạt khuyến mại KHỦNG đổ bộ cùng lúc dàng cho các tín đồ của TIX đây.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
                  <img src="./images/iconComment.png" alt="" />1
              ...
              <div className="col-md-4 block-news-img block-new-one">
                ...
                <p className="txt">
                  Từ giờ đến 05.12.2019, chỉ cần lần đầu mua vé trên 123Phim, chọn thanh toán bằng ZaloPay hoặc mục Vé
                  Phim trên ZaloPay, bạn có thể đặt ngay vé phim Anh Trai Yêu Quái với giá chỉ 11k/vé.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 1
                  <img src="./images/iconComment.png" alt="" />0
            ...
            <div className="row">
              ...
              <div className="col-md-6 block-news-img">
                ...
                <p className="txt">
                  Nhân dịp khai trương Galaxy Tràng Thi, Galaxy Cinema dành tặng các Stars Hà Nội loạt phần quà siêu hấp
                  dẫn.
                </p>
                <p className="icon-comment">
                  <i className="far fa-thumbs-up" /> 10
